  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        ...
        <Link href="/login" className="font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-blue-700 hover:to-purple-700 transition-all duration-200">
          Sign in
        </Link>
      </p>
    </form>
